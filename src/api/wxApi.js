...
export default class wxApi {
  ...
  static getListclassiFication(opts) {
    return wxHttp.get(
      `${API_URL_SUFFIX}/common/classification/listClassification`,
      opts
    );
  }
  // 获取具体足行信息
  ...
  // 添加商品
  static postAddCart(opts) {
    return wxHttp.post(`${API_URL_SUFFIX}/cart/addCart`, opts);
  }
  // 获取地址
  ...
  static getClassificationPrice(opts) {
    return wxHttp.get(
      `${API_URL_SUFFIX}/common/classification/getClassificationPrice`,
      opts
    );
  }
  // 获取城市经纬度
  ...
  // 修改数量
  static putupdateNum(opts) {
    return wxHttp.put(`${API_URL_SUFFIX}/cart/updateNum`, opts);
  }
  // 获取金额
  ...
  // 海报
  static postSharePoster(opts) {
    return wxHttp.post(`${API_URL_SUFFIX}/share/createSharePoste`, opts);
  }
  // 购物车价格
  static getCartPrice(opts) {
    return wxHttp.get(`${API_URL_SUFFIX}/cart/getCartPrice`, opts);
  }
  // 购物车
  static getCart(opts) {
    return wxHttp.get(`${API_URL_SUFFIX}/cart/getCart`, opts);
  }
}
